...
var hoist_non_react_statics = __webpack_require__(140);
...
var _freeGlobal = __webpack_require__(180);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(137), __webpack_require__(169)(module)))
...
exports.competitionsFetchError = exports.updateCompetitions = exports.competitionsIsLoading = exports.fetchCompetitions = undefined;

var _fixtureCompetitionActionType = __webpack_require__(136);

var types = _interopRequireWildcard(_fixtureCompetitionActionType);

var _ApiService = __webpack_require__(157);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var fetchCompetitions = exports.fetchCompetitions = function fetchCompetitions(selectedData) {
	return function (dispatch) {
		dispatch(competitionsIsLoading(true));

		(0, _ApiService.getCompetitions)(selectedData, function (data) {
...
var competitionsIsLoading = exports.competitionsIsLoading = function competitionsIsLoading(isLoading) {
	return {
...
var updateCompetitions = exports.updateCompetitions = function updateCompetitions(competitions) {
	return {
...
var competitionsFetchError = exports.competitionsFetchError = function competitionsFetchError(isError) {
	return {
...
exports.setSelectedDate = exports.changeSelectedDate = undefined;

var _fixturesNavigationActionType = __webpack_require__(135);

var types = _interopRequireWildcard(_fixturesNavigationActionType);

var _fixtureCompetitionAction = __webpack_require__(10);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var changeSelectedDate = exports.changeSelectedDate = function changeSelectedDate(selectedDate) {
	return function (dispatch) {
		dispatch(setSelectedDate(selectedDate));
		dispatch((0, _fixtureCompetitionAction.fetchCompetitions)(selectedDate));
	};
};

var setSelectedDate = exports.setSelectedDate = function setSelectedDate(selectedDate) {
	return {
...
var SELECTED_DATE_CHANGED = exports.SELECTED_DATE_CHANGED = 'selectedDateChanged';
var SET_SELECTED_DATE = exports.SET_SELECTED_DATE = 'setSelectedDate';
...
var COMPETITIONS_IS_LOADING = exports.COMPETITIONS_IS_LOADING = 'competitionsIsLoading';
var UPDATE_COMPETITIONS = exports.UPDATE_COMPETITIONS = 'updateCompetitions';
var COMPETITIONS_FETCH_ERROR = exports.COMPETITIONS_FETCH_ERROR = 'competitionsFetchError';
...
var FixturesNavigationBar = function FixturesNavigationBar(_ref) {
	var selectedDate = _ref.selectedDate,
	    onBackwardClicked = _ref.onBackwardClicked,
	    onForwardClicked = _ref.onForwardClicked;

	return _react2.default.createElement(
		'div',
		{ className: 'fixtures-navigation-bar' },
		_react2.default.createElement(
			'span',
			{ className: 'fixtures-navigation-bar-title' },
			'Fixtures'
		),
		_react2.default.createElement(
			'span',
			{ className: 'fixtures-navigation-bar-date' },
			selectedDate
		),
		_react2.default.createElement('div', { className: 'fixtures-navigation-bar-button font-icon arrow backward', onClick: onBackwardClicked }),
		_react2.default.createElement('div', { className: 'fixtures-navigation-bar-button font-icon arrow', onClick: onForwardClicked })
	);
};

FixturesNavigationBar.propTypes = {
	selectedDate: _propTypes2.default.string.isRequired
};

exports.default = FixturesNavigationBar;
...
var _fixturesNavigationAction = __webpack_require__(11);

var _FixturesNavigationBar = __webpack_require__(144);

var _FixturesNavigationBar2 = _interopRequireDefault(_FixturesNavigationBar);
...
var FixturesNavigationBarContainer = function (_Component) {
	_inherits(FixturesNavigationBarContainer, _Component);

	function FixturesNavigationBarContainer() {
		_classCallCheck(this, FixturesNavigationBarContainer);

		var _this = _possibleConstructorReturn(this, (FixturesNavigationBarContainer.__proto__ || Object.getPrototypeOf(FixturesNavigationBarContainer)).call(this));

		_this.onBackwardClicked = _this.onBackwardClicked.bind(_this);
		_this.onForwardClicked = _this.onForwardClicked.bind(_this);
		return _this;
	}

	_createClass(FixturesNavigationBarContainer, [{
		key: 'onBackwardClicked',
		value: function onBackwardClicked() {
		...
		value: function render() {
			...
			return _react2.default.createElement(_FixturesNavigationBar2.default, {
	...
	return FixturesNavigationBarContainer;
}(_react.Component);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		changeSelectedDate: function changeSelectedDate(newDate) {
			return dispatch((0, _fixturesNavigationAction.changeSelectedDate)(newDate));
		}
	};
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(FixturesNavigationBarContainer);
...
var _matchStatus = __webpack_require__(9);
...
var FixtureEventScore = function FixtureEventScore(prop) {
	var status = prop.status;


	if (status === _matchStatus2.default.TIMED || status === _matchStatus2.default.POSTPONED) {
		return _react2.default.createElement(
			'div',
			{ className: 'fixture-event-vs' },
			'vs'
		);
	}

	var _prop$score = prop.score,
	    home = _prop$score.home,
	    away = _prop$score.away;


	return _react2.default.createElement(
		'div',
		{ className: 'fixture-event-score ' + (prop.status === _matchStatus2.default.IN_PLAY ? 'inplay' : '') },
		_react2.default.createElement(
			'div',
			{ className: 'fixture-event-score-item' },
			home
		),
		_react2.default.createElement(
			'span',
...
exports.default = FixtureEventScore;
...
var _FixtureEventScore = __webpack_require__(148);

var _FixtureEventScore2 = _interopRequireDefault(_FixtureEventScore);
...
var getStatus = function getStatus(status, date) {
	switch (status) {
		case _matchStatus2.default.TIMED:
		case _matchStatus2.default.SCHEDULED:
			return (0, _moment2.default)(date).format('HH:mm');
		case _matchStatus2.default.IN_PLAY:
			return 'Inplay';
		case _matchStatus2.default.FINISHED:
			return 'Finished';
		case _matchStatus2.default.POSTPONED:
			return 'Postponed';
		default:
			return '';
	}
...
var FixtureEvent = function FixtureEvent(prop) {
	var _prop$event = prop.event,
	    date = _prop$event.date,
	    homeTeamName = _prop$event.homeTeamName,
	    awayTeamName = _prop$event.awayTeamName,
	    score = _prop$event.score,
	    status = _prop$event.status;
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			'div',
			{ className: 'event-status ' + (status === _matchStatus2.default.IN_PLAY ? 'inplay' : '') },
			getStatus(status, date)
		),
		_react2.default.createElement(
			'div',
			{ className: 'event-team home' },
			homeTeamName
		),
		_react2.default.createElement(_FixtureEventScore2.default, { score: score, status: status }),
		_react2.default.createElement(
			'div',
			{ className: 'event-team away' },
			awayTeamName
		)
	);
};

exports.default = FixtureEvent;
...
var _FixtureEvent = __webpack_require__(149);

var _FixtureEvent2 = _interopRequireDefault(_FixtureEvent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var FixtureEventList = function FixtureEventList(_ref) {
	...
	return _react2.default.createElement(
		...
		events.map(function (event) {
			return _react2.default.createElement(_FixtureEvent2.default, { key: event.id, event: event });
		})
	);
};
...
exports.default = FixtureEventList;
...
var _FixtureEventList = __webpack_require__(150);

var _FixtureEventList2 = _interopRequireDefault(_FixtureEventList);

__webpack_require__(197);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var FixtureCompetition = function FixtureCompetition(_ref) {
	var competition = _ref.competition;
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			competition.country + ': ' + competition.caption
		),
		_react2.default.createElement(_FixtureEventList2.default, { events: competition.events })
	);
};

exports.default = FixtureCompetition;
...
var _FixtureCompetition = __webpack_require__(151);

var _FixtureCompetition2 = _interopRequireDefault(_FixtureCompetition);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var FixtureCompetitionList = function FixtureCompetitionList(_ref) {
	...
	return _react2.default.createElement(
		...
		competitions.map(function (competition) {
			return _react2.default.createElement(_FixtureCompetition2.default, { key: competition.id, competition: competition });
		})
	);
};

FixtureCompetitionList.propTypes = {
	competitions: _propTypes2.default.array.isRequired
};

exports.default = FixtureCompetitionList;
...
var _FixtureCompetitionList = __webpack_require__(152);

var _FixtureCompetitionList2 = _interopRequireDefault(_FixtureCompetitionList);

var _fixtureCompetitionAction = __webpack_require__(10);

var _Loading = __webpack_require__(147);

var _Loading2 = _interopRequireDefault(_Loading);

var _Info = __webpack_require__(146);
...
var FixtureCompetitionListContainer = function (_Component) {
	_inherits(FixtureCompetitionListContainer, _Component);

	function FixtureCompetitionListContainer() {
		_classCallCheck(this, FixtureCompetitionListContainer);

		return _possibleConstructorReturn(this, (FixtureCompetitionListContainer.__proto__ || Object.getPrototypeOf(FixtureCompetitionListContainer)).apply(this, arguments));
	}

	_createClass(FixtureCompetitionListContainer, [{
		...
		value: function render() {
			var _props = this.props,
			    ...
			    competitions = _props.competitions,
			    isFetchError = _props.isFetchError;


			if (isLoading) {
				return _react2.default.createElement(_Loading2.default, null);
			} else if (isFetchError) {
				return _react2.default.createElement(_Info2.default, { msg: 'Unable to fetch events. Try again later.' });
			} else if (competitions.length === 0) {
				return _react2.default.createElement(_Info2.default, { msg: 'No events' });
			}

			return _react2.default.createElement(_FixtureCompetitionList2.default, { competitions: competitions });
		}
	}]);

	return FixtureCompetitionListContainer;
}(_react.Component);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		fetchCompetitions: function fetchCompetitions() {
			return dispatch((0, _fixtureCompetitionAction.fetchCompetitions)());
		}
	};
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(FixtureCompetitionListContainer);
...
function getCompetitions(selectedDate, onSuccess, onError) {
  setTimeout(function () {
    onSuccess([builder.build(), builder.eventsNum(2).build()]);
  }, 1000);
}

var CompetitionBuilder = function () {
  function CompetitionBuilder() {
    _classCallCheck(this, CompetitionBuilder);
  ...
  _createClass(CompetitionBuilder, [{
    key: 'eventsNum',
    value: function eventsNum(num) {
      var i = 0;
    ...
    value: function build() {
      ...
      var returnCompetition = Object.assign(this.competition, competitionData);
      this.competition = this.getInitCompetition();
      return returnCompetition;
    }
  }, {
    key: 'getInitCompetition',
    value: function getInitCompetition() {
...
async function getCompetitions(selectedDate, onSuccess, onError) {
  try {
    var fixturesParams = getRequestParams(selectedDate);
    var fixturesUrl = '' + url.FIXTURES + fixturesParams;
    var fixturesResponse = await fetch(fixturesUrl, fetchOptions);
    var fixturesData = await fixturesResponse.json();

    var parsedData = parseEvents(fixturesData ? fixturesData.matches : []);

    var competitionPromises = parsedData.filter(function (competition) {
      return !competitionMap[competition.id];
    }).map(async function (competition) {
      var response = await fetch(url.COMPETITIONS + '/' + competition.id, fetchOptions);
    ...
    try {
      for (var _iterator = competitionPromises[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var competitionPromise = _step.value;

        var competition = await competitionPromise;
    ...
    parsedData.forEach(function (competition) {
...
function parseEvents(fixtures) {
  var competitionsMap = fixtures.map(function (fixture) {
    return {
      id: fixture.id,
  ...
  }).reduce(function (accumulator, fixture) {
  ...
  try {
    for (var _iterator2 = Object.entries(competitionsMap)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var _step2$value = _slicedToArray(_step2.value, 2),
          id = _step2$value[0],
          events = _step2$value[1];
...
function sortEvents(events) {
  var sortedEvents = [].concat(_toConsumableArray(events));
...
function getRequestParams(date) {
  if (date) {
    var fixturesDate = date.format('YYYY-MM-DD');
...
var _FootballDataApiService = __webpack_require__(156);

var footballDataApi = _interopRequireWildcard(_FootballDataApiService);

var _MockApiService = __webpack_require__(155);

var mockApi = _interopRequireWildcard(_MockApiService);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var currentService = footballDataApi;

function getCompetitions() {
	return currentService.getCompetitions.apply(currentService, arguments);
}
...
var Header = function Header(props) {
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			'span',
			{ className: 'app-header-title', onClick: props.onHeaderClicked },
			'My Football'
		)
	);
};
...
var HeaderContainer = function (_Component) {
	...
	function HeaderContainer(_ref) {
		...
		_this.onHomeButtonClicked = _this.onHomeButtonClicked.bind(_this);
		return _this;
	}

	_createClass(HeaderContainer, [{
		key: 'onHomeButtonClicked',
		value: function onHomeButtonClicked() {
			this.dispatch((0, _fixturesNavigationAction.changeSelectedDate)((0, _moment2.default)()));
		}
	}, {
		key: 'render',
		value: function render() {
			return _react2.default.createElement(_Header2.default, { onHeaderClicked: this.onHomeButtonClicked });
		}
	}]);
...
exports.default = (0, _reactRedux.connect)()(HeaderContainer);
...
var _HeaderContainer = __webpack_require__(159);
...
var _FixtureCompetitionListContainer = __webpack_require__(153);

var _FixtureCompetitionListContainer2 = _interopRequireDefault(_FixtureCompetitionListContainer);

var _FixturesNavigationBarContainer = __webpack_require__(145);

var _FixturesNavigationBarContainer2 = _interopRequireDefault(_FixturesNavigationBarContainer);
...
var App = function App() {
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_FixturesNavigationBarContainer2.default, null),
			_react2.default.createElement(_FixtureCompetitionListContainer2.default, null)
		),
...
exports.selectedDate = undefined;
...
var selectedDate = exports.selectedDate = function selectedDate() {
...
exports.isCompetitionsFetchError = exports.competitions = exports.competitionsIsLoading = undefined;
...
var competitionsIsLoading = exports.competitionsIsLoading = function competitionsIsLoading() {
...
var competitions = exports.competitions = function competitions() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	var actions = arguments[1];
...
var isCompetitionsFetchError = exports.isCompetitionsFetchError = function isCompetitionsFetchError() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
	var actions = arguments[1];
...
var _fixtureCompetitionReducer = __webpack_require__(164);

var _fixturesNavigationBarReducer = __webpack_require__(163);

exports.default = (0, _redux.combineReducers)({
	competitions: _fixtureCompetitionReducer.competitions,
	competitionsIsLoading: _fixtureCompetitionReducer.competitionsIsLoading,
	isCompetitionsFetchError: _fixtureCompetitionReducer.isCompetitionsFetchError,
	selectedDate: _fixturesNavigationBarReducer.selectedDate
});
...
*/
var ba=__webpack_require__(7),ea=__webpack_require__(1),m=__webpack_require__(175),A=__webpack_require__(139),C=__webpack_require__(6),fa=__webpack_require__(174),ha=__webpack_require__(173),ja=__webpack_require__(172),ka=__webpack_require__(138);
...
var _rootReducer = __webpack_require__(165);
...
var _reduxDevtoolsExtension = __webpack_require__(142);
